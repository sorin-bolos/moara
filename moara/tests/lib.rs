...
fn measure_state0_returns0() {
    let amplitude0 = Complex32::new(1.0,0.0);
    let amplitude1 = Complex32::new(0.0,0.0);
    assert_eq!(0, moara::measure([amplitude0, amplitude1]));
}

#[test]
fn measure_state1_returns1() {
    let amplitude0 = Complex32::new(0.0,0.0);
    let amplitude1 = Complex32::new(1.0,0.0);
    assert_eq!(1, moara::measure([amplitude0, amplitude1]));
}
...
fn measure_state_plus_returns_equal_probabilities() {
    ...
    let sums = (0..1000).map(|_| moara::measure([amplitude0, amplitude1]))
